...
function validate_form() {
	...
	// 获得校验结果，显示提示信息
	var result1 = validate("#in_id", regId, "9位以内数字");
	var result2 = validate("#in_name", regName, "2到10个中英文");
	var result3 = validate("#in_pass", regWord, "密码至少4位，由英文和数字组成");
	var result4 = validate("#in_email", regEmail, "邮箱格式不正确");
	// 返回校验结果
